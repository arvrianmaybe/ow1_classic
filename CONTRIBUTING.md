...
- GitHub
    ...
    - [Issue](https://github.com/arvrianmaybe/ow1_classic/issues) tracking and [Pull Request](https://github.com/arvrianmaybe/ow1_classic/pulls)
- Discord
...
1. Find an [issue](https://github.com/arvrianmaybe/ow1_classic/issues) to fix (or submit one yourself).
...
7. Submit [Pull Request](https://github.com/arvrianmaybe/ow1_classic/pulls) (PR) to merge your branch into staging branch.
...
4. No [magic numbers](https://stackoverflow.com/q/47882). Constants should always be referred to by the names defined in [src/constants](https://github.com/arvrianmaybe/ow1_classic/tree/staging/src/constants).
...
6. Keep rules simple; each rule should only perform one task. Try to limit rules to at most 10 lines of code and group large blocks of code into subroutines whenever possible. See [src/heroes/bastion](https://github.com/arvrianmaybe/ow1_classic/tree/staging/src/heroes/bastion) as an example.
